...
if(WITH_RUBBERBAND)
	...
	if(NOT LIBRUBBERBAND_FOUND)
		message(FATAL_ERROR "Librubberband library not found. If you with to skip rubberband support, set WITH_RUBBERBAND to OFF when configuring.")
	else()
